...
<div class="col-md-12 col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title text-center">Tambah Mata Kuliah</h4>
        </div>
        <div class="card-content">
            <div class="card-body">
                <form class="form form-horizontal" method="POST" action="{{route('matkul.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                ...
                                @enderror" name="kode" value="{{ old('kode') }}" placeholder="KODE">
                                @error('kode')
                            ...
                            <div class="col-md-8 form-group">
                                ...
                                @enderror" name="matkul" value="{{ old('matkul') }}" placeholder="Mata Kuliah">
                                @error('matkul')
                                <div class="alert alert-danger mt-1 text-center">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                ...
                                @enderror" name="kelas" value="{{ old('kelas')}}" placeholder="Kelas">
                                @error('kelas')
                                <div class="alert alert-danger mt-1 text-center">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                ...
                                @enderror" name="pengajar" value="{{ old('pengajar')}}" placeholder="Pengajar">
                                @error('pengajar')
                                <div class="alert alert-danger mt-1 text-center">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                ...
                                @enderror" name="jam" value="{{ old('jam')}}" placeholder="Jam">
                                @error('jam')
                                <div class="alert alert-danger mt-1 text-center">{{$message}}</div>
                                @enderror
                            </div>
